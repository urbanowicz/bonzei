...
public class ClockFaceAndDots : NSObject {
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 329, height: 256), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Dots
        //// Oval 10 Drawing
        let oval10Path = UIBezierPath(ovalIn: CGRect(x: 0, y: 211, width: 44.93, height: 44.93))
        context.saveGState()
        oval10Path.addClip()
        context.drawLinearGradient(linearGradient7,
            start: CGPoint(x: 21.19, y: 227.37),
            end: CGPoint(x: 11.27, y: 257.51),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()


        //// Oval-Copy-3 Drawing
        let ovalCopy3Path = UIBezierPath(ovalIn: CGRect(x: 310, y: 112, width: 19.38, height: 19.38))
        context.saveGState()
        ovalCopy3Path.addClip()
        context.drawLinearGradient(linearGradient7,
            start: CGPoint(x: 319.14, y: 119.06),
            end: CGPoint(x: 314.86, y: 132.06),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()


        //// Oval-Copy-4 Drawing
        let ovalCopy4Path = UIBezierPath(ovalIn: CGRect(x: 53, y: 0, width: 19.38, height: 19.38))
        context.saveGState()
        ovalCopy4Path.addClip()
        context.drawLinearGradient(linearGradient7,
            start: CGPoint(x: 62.14, y: 7.06),
            end: CGPoint(x: 57.86, y: 20.06),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
